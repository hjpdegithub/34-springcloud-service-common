...
//            String pathName = "/mnt/file/"+name;
            String pathName = "/nas/file/"+name;
            // 创建OSSClient实例。
            OSSClient ossClient = new OSSClient(endpoint, accessKeyId, accessKeySecret,config);
...
//
//            //    File aa =    new File("D:\\show\\"+"test.txt");
//            File file = new File("D:/show/"+fileName);
//           // file.createNewFile();
//
//            //OSSClient ossClient = new OSSClient(endpoint,accessKeyId,accessKeySecret,config);
//            OSS  ssossClient=new OSSClientBuilder().build(endpoint,accessKeyId,accessKeySecret);
//
//            ssossClient.getObject(
//                    new GetObjectRequest(bucketName, FileFullPath) ,
//                    file
            // );
...
//            }
        ...
        return "http://" +"open.sgcc.com.cn/mp"+"/showresource/"+name ;
//        return "http://" +ipAdress+":8080"+"/showresource/"+name ;
    }
